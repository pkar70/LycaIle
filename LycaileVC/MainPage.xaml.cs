...
namespace LycaIle
{
    ...
    public sealed partial class MainPage : Windows.UI.Xaml.Controls.Page
    {
        ...
        private async System.Threading.Tasks.Task<bool> ZrobOCR(Windows.Storage.StorageFile oFile)
        {
            ...
            Windows.Media.Ocr.OcrResult rOCR = await Windows.Media.Ocr.OcrEngine.TryCreateFromUserProfileLanguages().RecognizeAsync(oBmp);
